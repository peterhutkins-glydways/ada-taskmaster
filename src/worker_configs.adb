...
package body Worker_Configs
   ...
   function Get_Init_Callable (Config : Worker_Config) return access Callable_Type
   is
   begin
   ...
   function Get_Triggered_Callable (Config : Worker_Config) return access Callable_Type
   is
   begin
   ...
   function Get_Time_Limit (Config : Worker_Config) return Time_Span is
   begin
